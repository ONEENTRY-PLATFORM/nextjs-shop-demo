...
const ContactInfo: React.FC = () => {
  return (
    <div className="flex flex-col ml-5 w-[23%] max-md:ml-0 max-md:w-full">
      <nav className="flex flex-col grow font-bold text-neutral-600 max-sm:mb-5">
        ...
        <div className="flex flex-col gap-1.5 text-sm leading-5 whitespace-nowrap">
          ...
          <a href="tel:+9100006789101" className="mr-auto">+91(0000)5678910</a>
          <a href="tel:+9100006789101" className="mr-auto">+91(0000)6789101</a>
          <div className="mr-auto text-orange-500">Web</div>
          <a href="mailto:info@oneentry.com" className="mr-auto">info@oneentry.com</a>
          <a href="mailto:info@oneentry.com" className="mr-auto">oneentry@gmail.com</a>
        </div>
      </nav>
    </div>
  );
