...
const HistoryBack = (): JSX.Element => {
  ...
  return (
    ...
    <button
      type="button"
      className="group flex size-12 cursor-pointer items-center justify-center rounded-full border border-solid border-slate-200 bg-white transition-colors duration-200 hover:border-orange-500 max-sm:p-3 md:size-10 md:p-3 lg:size-12.5 lg:p-3.5"
      aria-label="Go back"
      onClick={() => router.back()}
    >
      ...
      <svg
        ...
        viewBox="0 0 26 21"
        fill="none"
        className="fill-foreground group-hover:fill-orange-500"
      >
