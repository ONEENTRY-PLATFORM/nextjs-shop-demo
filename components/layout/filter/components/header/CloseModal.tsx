...
const CloseModal = (): JSX.Element => {
  ...
  return (
    ...
    <button
      className="z-10 size-12 cursor-pointer items-center justify-center rounded-full border border-solid border-slate-200 bg-white text-lg text-slate-800 transition-colors hover:border-orange-500 hover:text-orange-500 md:size-10 lg:size-12.5 lg:p-2.5"
      onClick={() => {
