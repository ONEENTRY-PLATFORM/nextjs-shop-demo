...
const HistoryBack: React.FC = () => {
  ...
  return (
    <button
      type="button"
      className="group flex size-12 items-center justify-center rounded-full border border-solid border-slate-200 bg-white p-3.5 transition-colors duration-200 hover:border-orange-500 md:size-[40px] lg:size-[50px]"
      aria-label="Go back"
      // onClick={() => router.back()}
    >
      <svg
