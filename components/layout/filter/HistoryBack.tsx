...
const HistoryBack: React.FC = () => {
  ...
  return (
    <button
      type="button"
      className="group flex size-12 items-center justify-center rounded-full border border-solid border-slate-200 p-2 hover:border-orange-500 md:size-[40px] lg:size-[50px]"
      aria-label="Go back"
      // onClick={() => router.back()}
    >
      <svg
