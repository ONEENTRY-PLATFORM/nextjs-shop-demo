...
const SearchBar = ({
   ...
   */
  return (
    <div className="fade-in rounded-btn relative my-auto ml-9 flex h-12.5 w-fit shrink-0 grow basis-0 flex-row items-center justify-end gap-5 border border-solid border-[#A8A9B5] bg-white text-slate-800 transition-all duration-500 max-md:ml-0 max-md:h-12.5 max-md:max-w-full max-md:px-0 max-sm:hidden max-sm:h-10 max-sm:gap-0 max-sm:px-4 max-sm:pr-1">
