...
const BackButton: React.FC = () => {
  ...
  return (
    <button
      type="button"
      className="group flex size-[36px] items-center justify-center rounded-3xl border border-solid border-gray-400 bg-white p-2 hover:border-orange-500 md:size-[40px] lg:size-[50px]"
      aria-label="Go back"
      onClick={() => router.back()}
    >
      <svg
