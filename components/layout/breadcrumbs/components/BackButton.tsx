...
const BackButton = (): JSX.Element => {
  ...
  return (
    <button
      type="button"
      className="group flex size-9 cursor-pointer items-center justify-center rounded-full border border-solid border-gray-400 bg-white p-2 transition-colors duration-300 hover:border-orange-500 md:size-10 lg:size-12.5 lg:p-3.5"
      aria-label="Go back"
      onClick={() => router.back()}
    >
      ...
      <svg
        ...
        viewBox="0 0 26 21"
        fill="none"
        className="fill-foreground transition-colors duration-300 group-hover:fill-orange-500"
      >
