...
/**
 * Card animations client wrapper
 * @param children children ReactNode
 * @param className CSS className of ref element
 * @param index Index of element for animations stagger
 * @param pagesLimit used for animations
 * @param currentPage current page number from parent
 * @see {@link https://gsap.com/cheatsheet/ gsap cheatsheet}
 * @returns Card animations
 */
const CardAnimationsClient: FC<{
  children: ReactNode;
  className: string;
  index: number;
  pagesLimit: number;
  currentPage: number;
}> = ({ children, className, index, pagesLimit, currentPage }) => {
...
export default CardAnimationsClient;
